...
class lmhash_test(EncodingHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("ENCYCLOP\xc6DIA", "fed6416bffc9750d48462b9d7aaac065"),
        ("encyclop\xe6dia", "fed6416bffc9750d48462b9d7aaac065"),
        # test various encoding values
        (("\xc6", None), "25d8ab4a0659c97aaad3b435b51404ee"),
        (("\xc6", "cp437"), "25d8ab4a0659c97aaad3b435b51404ee"),
        (("\xc6", "latin-1"), "184eecbbe9991b44aad3b435b51404ee"),
        (("\xc6", "utf-8"), "00dd240fcfab20b8aad3b435b51404ee"),
    ]
...
class _md5_crypt_test(HandlerCase):
    ...
    known_correct_hashes = [
        ...
        ("s", "$1$ssssssss$YgmLTApYTv12qgTwBoj8i/"),
        # ensures utf-8 used for unicode
...
class msdcc_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (("\u00fc", "\u00fc"), "48f84e6f73d6d5305f6558a33fa2c9bb"),
        (("\u00fc\u00fc", "\u00fc\u00fc"), "593246a8335cf0261799bda2a2a9c623"),
        (("\u20ac\u20ac", "user"), "9121790702dda0fa5d353014c334c2ce"),
        #
        # custom
        #
        # ensures utf-8 used for unicode
...
class msdcc2_test(UserHandlerMixin, HandlerCase):
    ...
    known_correct_hashes = [
        ...
        (("\u00fc", "joe"), "bdb80f2c4656a8b8591bd27d39064a54"),
        (("\u20ac\u20ac", "joe"), "1e1e20f482ff748038e47d801d0d1bda"),
        (("\u00fc\u00fc", "admin"), "0839e4a07c00f18a8c65cf5b985b9e73"),
        #
        # custom
        #
        # custom unicode test
