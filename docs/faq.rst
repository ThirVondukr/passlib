...
* **Do I need to provide a salt each time I** :meth:`~PasswordHash.hash` **a password,
  and store it separately in my database?**
  ...
  There are just a few hashes which require something external (like a username),
  or don't contain a salt at all.  These generally aren't secure, and shouldn't
  be used in new applications anyways.
...
* **How do I decrypt the hashes generated by Passlib?**
  ...
  *Long answer:*
  ...
  There is one single decryptable hash in Passlib: :doc:`lib/passlib.hash.cisco_type7`,
